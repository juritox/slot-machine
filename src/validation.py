...
from config import (
    ...
    PULL_COST, WIN_PRIZE, FRAME_PADDING_FACTOR, LEVER_LEFT_OR_RIGHT
)
...
def validate_configurations() -> None:
    ...
    if LEVER_LEFT_OR_RIGHT not in ("left", "right"):
        errors.append("LEVER_RIGHT_OR_LEFT must be either 'left' or 'right'.")
